...
public class DataLogger : MonoBehaviour
{
    ...
    private void init() {
        ...
        if (swFlow == null)
        {
            ...
            swFlow.WriteLine("Time,Name,Shirtcolor,Hair");            // swFlow.WriteLine("Time,Name,HasTicket,Shirtcolor,Hair");
            swFlow.Flush();
        }
    ...
    public void writeVisitorClick(double timestamp, string name, string type)           // public void writeVisitorClick(double timestamp, string name, bool hasTicket, string type)
    {
        ...
        swVisitor.WriteLine(timestamp + "," + name + "," + type);     // swVisitor.WriteLine(timestamp + "," + name + "," + hasTicket + "," + type);
        swVisitor.Flush();
    }
    ...
    public void writeFlow(double timestamp, string name, string shirtcolor, string hair)        // public void writeFlow(double timestamp, string name, bool hasticket, string shirtcolor, string hair)
    {
        ...
        swFlow.WriteLine(timestamp + "," + name + "," + shirtcolor + "," + hair);     // swFlow.WriteLine(timestamp + "," + name + "," + hasticket + "," + shirtcolor + "," + hair);
        swFlow.Flush();
    }
